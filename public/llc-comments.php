...
<div id="llc_comments">
    <div style="text-align: center;">
        ...
        <?php if ( get_option( 'lazy_load_comments', 1 ) == 1 ) : ?>
            ...
            <button id="llc_comments_button" class="btn <?php echo apply_filters( 'llc_button_class', '' ); ?>"><?php echo apply_filters( 'llc_button_text', __( 'Load Comments', LLC_DOMAIN ) ); ?></button>
        <?php endif; ?>
    </div>
</div>